...
<script >
   var gallery="{{url('uploaded_images/'.Auth::id().'')}}";
...
<body>
   <section class="detail-page bg-image--parallax">
      <div class="container">
         <h3 class="mb-5 font-weight-700 text-white text-effect">Add Property</h3>
         <div class="row gx-lg-5">
            <div class="col-lg-8">
               <form class="generic-form" id="form99" method="POST"  action="{{route('services.store')}}" >
                @csrf
                  <div class="row gx-5 mb-3">
                     <div class="col-lg-6 col-md-12">
                        <div class="form-group">
                           <label>Title</label>
                           <input type="text" name="title" value="{{old('title')}}" maxlength="256"  required class="form-control" />
                            @error('title')
                     ...
                     <div class="col-lg-6 col-md-12">
                        <div class="form-group">
                           <label>Price</label>
                           <input type="number" name="price" value="{{old('price')}}" step="0.01"  max="1000000" class="form-control" />
                        </div>
                     </div>
                      <div class="col-lg-6 col-md-12">
                        <div class="form-group">
                           <label>Email</label>
                           <input type="email" name="email" value="{{old('email')}}"  maxlength="256" class="form-control" />
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-12">
                        <div class="form-group">
                           <label>Contact Name</label>
                           <input type="text" name="contact_name" required maxlength="256" value="{{old('contact_name')}}" class="form-control" />
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-12">
                        <div class="form-group">
                           <label>Contact Number</label>
                           <input type="tel" maxlength="16" required onkeyup="numbersOnly(this)"  name="contact_number" maxlength="256" value="{{old('contact_number')}}"  placeholder="+4930901820" class="form-control" />
                        </div>
                     </div>
                     <div class="col-md-12">
                        <div class="form-group">
                           <label>Description (Maximum 2000 characters)</label>
                           <textarea class="form-control" maxlength="2000" name="description"  id="editor1" rows="10" cols="80">{{old('description')}}</textarea>
                        </div>
                     </div>
                      ...
                      <div class="col-lg-6 col-md-12">
                        <div class="form-group">
                           ...
                           onfocus="this.removeAttribute('readonly');"  value="{{old('address')}}" name="address" type="text" placeholder="Enter a location" />
                               @error('address')
                        <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                        </span>
                  ...
                  <div class="mt-5 mb-3 text-end">
                   <a href="{{url('property')}}" class="btn btn-secondary text-white px-5 py-2 font-size-18">Cancel</a>
...
function initMap() {
    ...
    autocomplete.setComponentRestrictions({
        country: ["ES", "DE", "UK", "AT", "BE","BG", "HR", "CY", "CZ", "DK","EE", "FI", "FR", "GR", "HU","IE", "IT", "LV", "LT", "LU", "MT", "NL", "PL", "PT", "RO", "SK", "SI", "SE"],
    });
