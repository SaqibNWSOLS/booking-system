...
<body>
    <section class="auth-page">
        <div class="left-area">
            <h4 class="text-center mb-5 pb-4">Login</h4>
            <div class="text-center">
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="icon-wraper password-group">
                        <input type="password" name="password" class="password-box form-control" id="passInput" />
                ...
                <button class="btn btn-primary mt-4 w-100">Sign In</button>
            </form>
        </div>
