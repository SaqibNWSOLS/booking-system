...
Scheduler.plugin(function(e) {
    e.config.occurrence_timestamp_in_utc = !1, e.config.recurring_workdays = [1, 2, 3, 4, 5], e.form_blocks.recurring = {
            ...
            _get_node_value: function(e, t, a) {
                ...
                if (n.length) {
                    if (a) {
                        for (var i = [], r = 0; r < n.length; r++) n[r].checked && i.push(n[r].value);
                        return i
                    }
                    for (var r = 0; r < n.length; r++)
                        if (n[r].checked) return n[r].value
                }
            ...
            _set_node_value: function(e, t, a) {
                var n = e[t];
                if (n)
                    if (n.name == t) n.value = a;
                    else if (n.length)
                    for (var i = "object" == typeof a, r = 0; r < n.length; r++)(i || n[r].value == a) && (n[r].checked = i ? !!a[n[r].value] : !!a)
            },
            _init_set_value: function(t, a, n) {
                ...
                function r() {
                    b("dhx_repeat_day").style.display = "none",
                        b("dhx_repeat_week").style.display = "none", b("dhx_repeat_month").style.display = "none", b("dhx_repeat_year").style.display = "none", b("dhx_repeat_" + this.value).style.display = "block", e.setLightboxSize()
                }

                function o(t) {
                    var a = [c(g, "repeat")];
                    for (y[a[0]](a, t); a.length < 5;) a.push("");
                    var n = "",
                        i = d(g);
                    if ("no" == i) t.end = new Date(9999, 1, 1), n = "no";
                    else if ("date_of_end" == i) t.end = p(c(g, "date_of_end"));
                    else {
                        e.transpose_type(a.join("_")), n = Math.max(1, c(g, "occurences_count"));
                        var r = 0;
                ...
                function l(e, t) {
                    ...
                    if (a.length) {
                        ...
                        if (n)
                            for (var i = 0; i < a.length; i++) a[i].value == t && (a[i].checked = !0);
                        else {
                            var r = 0;
                            switch (t) {
                                case "no":
                ...
                function s(t, a) {
                    ...
                    switch (t = i[0].split("_"), x[t[0]](t, a), i[1]) {
                        ...
                        case "":
                            l(g, "date_of_end");
                            var r = a.end;
                            e.config.include_end_by && (r = e.date.add(r, -1, "day")), n(g, "date_of_end", v(r));
                            break;
                        default:
                            l(g, "occurences_count"), n(g, "occurences_count", i[1])
                    }
                    n(g, "repeat", t[0]);
                ...
                var y = {
                        ...
                        week: function(t, a) {
                            var n = e.form_blocks.recurring._get_node_value,
                                i = e.form_blocks.recurring._get_node_numeric_value;
                            t.push(Math.max(1, i(g, "week_count"))), t.push(""), t.push("");
                            for (var r = [], o = n(g, "week_day", !0), d = a.start.getDay(), l = !1, s = 0; s < o.length; s++) r.push(o[s]), l = l || o[s] == d;
                            r.length || (r.push(d), l = !0), r.sort(), e.config.repeat_precise ? l || (e.transpose_day_week(a.start, r, 1, 7), a._start = !0) : (a.start = e.date.week_start(a.start), a._start = !0), t.push(r.join(","))
                        },
                        day: function(t) {
                        ...
                        year: function(t, a) {
                            var n = e.form_blocks.recurring._get_node_value;
                            "d" == n(g, "year_type") ? (t.push("1"), a.start.setMonth(0), a.start.setDate(n(g, "year_day")), a.start.setMonth(n(g, "year_month"))) : (t.push("1"), t.push(n(g, "year_day2")), t.push(n(g, "year_week2")), a.start.setDate(1), a.start.setMonth(n(g, "year_month2"))), a._start = !0
                        }
                    },
                    x = {
                        week: function(t, a) {
                        ...
                        day: function(t, a) {
                            var n = e.form_blocks.recurring._set_node_value;
                            n(g, "day_type", "d"), n(g, "day_count", t[1]);
                        },
                        year: function(t, a) {
                            var n = e.form_blocks.recurring._set_node_value;
            ...
            set_value: function(t, a, n) {
                ...
                e._lightbox._rec_init_done || i._init_set_value(t, a, n), t.open = !n.rec_type, this._is_modified_occurence(n) ? t.blocked = !0 : t.blocked = !1;
                var r = i._ds;
                r.start = n.start_date, r.end = n._end_date, i.button_click(0, t.previousSibling.firstChild.firstChild, t, t), a && i._set_repeat_code(a, r)
            },
            get_value: function(t, a) {
                if (t.open) {
                    var n = e.form_blocks.recurring._ds,
                        i = {};
                    this.formSection("time").getValue(i), n.start = i.start_date, a.rec_type = e.form_blocks.recurring._get_repeat_code(n), n._start ? (a.start_date = new Date(n.start),
                        a._start_date = new Date(n.start), n._start = !1) : a._start_date = null, a._end_date = n.end, a.rec_pattern = a.rec_type.split("#")[0]
                } else a.rec_type = a.rec_pattern = "", a._end_date = a.end_date;
                return a.rec_type
            },
            ...
            _toggle_block: function() {
                var t = e.form_blocks.recurring,
                    a = t._get_form(),
                    n = t._get_button();
                a.open || a.blocked ? (a.style.height = "0px", n && (n.style.backgroundPosition = "-5px 20px", n.nextSibling.innerHTML = e.locale.labels.button_recurring)) : (a.style.height = "auto", n && (n.style.backgroundPosition = "-5px 0px", n.nextSibling.innerHTML = e.locale.labels.button_recurring_open)), a.open = !a.open, e.setLightboxSize()
            },
            focus: function(e) {},
            button_click: function(t, a, n, i) {
                e.form_blocks.recurring._toggle_block();
            }
        }, e._rec_markers = {}, e._rec_markers_pull = {}, e._add_rec_marker = function(e, t) {
        ...
        function() {
            ...
            e.addEvent = function(a, n, i, r, o) {
                ...
                if (d) {
                    var l = e.getEvent(d);
                    this._is_modified_occurence(l) && e._add_rec_marker(l, 1e3 * l.event_length), l.rec_type && (l.rec_pattern = l.rec_type.split("#")[0])
                }
                return d
            }
        }(), e.attachEvent("onEventIdChange", function(t, a) {
            if (!this._ignore_call) {
                this._ignore_call = !0, e._rec_markers[t] && (e._rec_markers[a] = e._rec_markers[t], delete e._rec_markers[t]), e._rec_markers_pull[t] && (e._rec_markers_pull[a] = e._rec_markers_pull[t], delete e._rec_markers_pull[t]);
            ...
            if (this._is_virtual_event(e) || this._is_modified_occurence(t) && t.rec_type && "none" != t.rec_type) {
                ...
                var r = n;
                i.event_length = r, i.rec_type = i.rec_pattern = "none", this.addEvent(i), this._add_rec_marker(i, 1e3 * r)
            } else {
                t.rec_type && this._lightbox_id && this._roll_back_dates(t);
                var o = this._get_rec_markers(e);
                for (var d in o) o.hasOwnProperty(d) && (e = o[d].id, this.getEvent(e) && this.deleteEvent(e, !0))
            }
            return !0
            ...
            !this._is_virtual_event(t) && this._is_modified_occurence(a) && (e._events[t] || (a.rec_type = a.rec_pattern = "none",
                this.setEvent(t, a)))
        }), e.attachEvent("onEventChanged", function(e) {
            ...
            if (this._is_virtual_event(e)) {
                var e = e.split("#"),
                    a = this.uid();
                this._not_render = !0;
                var n = this._copy_event(t);
                n.id = a, n.event_pid = e[0];
                var i = e[1];
                n.event_length = i, n.rec_type = n.rec_pattern = "", this._add_rec_marker(n, 1e3 * i), this.addEvent(n), this._not_render = !1
            } else {
                t.rec_type && this._lightbox_id && this._roll_back_dates(t);
                var r = this._get_rec_markers(e);
                for (var o in r) r.hasOwnProperty(o) && (delete this._rec_markers[r[o].id],
                    this.deleteEvent(r[o].id, !0));
        ...
        e.attachEvent("onEventCreated", function(e) {
            ...
            e.event_length = (e.end_date.valueOf() - e.start_date.valueOf()) / 1e3, e.end_date = e._end_date, e._start_date && (e.start_date.setMonth(0), e.start_date.setDate(e._start_date.getDate()), e.start_date.setMonth(e._start_date.getMonth()),
        ...
        }, e.showLightbox_rec = e.showLightbox, e.showLightbox = function(t) {
            var a = this.locale,
            ...
            if ((r || 1 * r === 0) && i.rec_type) return d(t);
        ...
        }, e.get_visible_events_rec = e.get_visible_events, e.get_visible_events = function(e) {
            for (var t = 0; t < this._rec_temp.length; t++) delete this._events[this._rec_temp[t].id];
            this._rec_temp = [];
            for (var a = this.get_visible_events_rec(e), n = [], t = 0; t < a.length; t++) a[t].rec_type ? "none" != a[t].rec_pattern && this.repeat_date(a[t], n) : n.push(a[t]);
            return n
        },
        function() {
            ...
            e.updateEvent = function(t) {
                var n = e.getEvent(t);
                n && n.rec_type && (n.rec_pattern = (n.rec_type || "").split("#")[0]), n && n.rec_type && !this._is_virtual_event(t) ? e.update_view() : a.call(this, t)
            }
        }(), e.transponse_size = {
            day: 1,
            week: 7,
            ...
            for (var o = (t.getDay() || (e.config.start_on_monday ? 7 : 0)) - n, d = 0; d < a.length; d++)
                if (a[d] > o) return t.setDate(t.getDate() + 1 * a[d] - o - (i ? n : r));
            ...
            if (!this.date[a]) {
                ...
                if ("day" == n[0] || "week" == n[0]) {
                    ...
                    if (n[4] && (d = n[4].split(","), e.config.start_on_monday)) {
                        for (var l = 0; l < d.length; l++) d[l] = 1 * d[l] || 7;
                        d.sort()
                    }
                    this.date[a] = function(t, a) {
                        var n = Math.floor((a.valueOf() - t.valueOf()) / (i * o));
                        n > 0 && t.setDate(t.getDate() + n * o), d && e.transpose_day_week(t, d, 1, o)
                    }, this.date[r] = function(t, a) {
                        var n = new Date(t.valueOf());
                        if (d)
                            for (var i = 0; a > i; i++) e.transpose_day_week(n, d, 0, o);
                        else n.setDate(n.getDate() + a * o);
                        return n
                    }
                } else("month" == n[0] || "year" == n[0]) && (this.date[a] = function(t, a) {
                    var i = Math.ceil((12 * a.getFullYear() + 1 * a.getMonth() - (12 * t.getFullYear() + 1 * t.getMonth())) / o);
                    i >= 0 && t.setMonth(t.getMonth() + i * o), n[3] && e.date.day_week(t, n[2], n[3])
                }, this.date[r] = function(t, a) {
            ...
            var d = o || -1,
                ...
                s = 0;
            for (!t.rec_pattern && t.rec_type && (t.rec_pattern = t.rec_type.split("#")[0]), this.transpose_type(t.rec_pattern), e.date["transpose_" + t.rec_pattern](l, i); l < t.start_date || e._fix_daylight_saving_date(l, i, t, l, new Date(l.valueOf() + 1e3 * t.event_length)).valueOf() <= i.valueOf() || l.valueOf() + 1e3 * t.event_length <= i.valueOf();) l = this.date.add(l, 1, t.rec_pattern);
            for (; r > l && l < t.end_date && (0 > d || d > s);) {
                var _ = e.config.occurrence_timestamp_in_utc ? Date.UTC(l.getFullYear(), l.getMonth(), l.getDate(), l.getHours(), l.getMinutes(), l.getSeconds()) : l.valueOf(),
                    c = this._get_rec_marker(_, t.id);
                if (c) n && ("none" != c.rec_type && s++, a.push(c));
                else {
                    var u = new Date(l.valueOf() + 1e3 * t.event_length),
                        h = this._copy_event(t);
                    if (h.text = t.text, h.start_date = l, h.event_pid = t.id, h.id = t.id + "#" + Math.ceil(_ / 1e3), h.end_date = u, h.end_date = e._fix_daylight_saving_date(h.start_date, h.end_date, t, l, h.end_date), h._timed = this.isOneDayEvent(h), !h._timed && !this._table_view && !this.config.multi_day) return;
                    a.push(h), n || (this._events[h.id] = h, this._rec_temp.push(h)), s++
                }
            ...
            var n = "object" == typeof t ? t : e.getEvent(t),
                i = [];
            if (a = a || 100, !n.rec_type) return [{
                start_date: n.start_date,
                end_date: n.end_date
            }];
            if ("none" == n.rec_type) return [];
            e.repeat_date(n, i, !0, n.start_date, n.end_date, a);
            for (var r = [], o = 0; o < i.length; o++) "none" != i[o].rec_type && r.push({
            ...
            for (var n in this._events) {
                ...
                if (i && i.start_date < t && i.end_date > e)
                    if (i.rec_pattern) {
                        if ("none" == i.rec_pattern) continue;
                        var r = [];
                        this.repeat_date(i, r, !0, e, t);
                        for (var o = 0; o < r.length; o++) !r[o].rec_pattern && r[o].start_date < t && r[o].end_date > e && !this._rec_markers[r[o].id] && a.push(r[o])
                    } else this._is_virtual_event(i.id) || a.push(i)
            }
            return a
